...
// ─────────────────────────────────────────────────────────────────────────────
// Zod — query schema (sent to backend, validated client-side)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Response row type — no Zod validation on the response
// ─────────────────────────────────────────────────────────────────────────────
export interface BudgetRow {
    ...
    requested_by: string;
    requested_by_empno: string;   // ← add this
    total_amount: number;
    status: string | null;
...
export function BudgetView({ t, isDark, canSwitch, onSwitchRole, departments = [], sections = [] }: BudgetViewProps) {
    ...
    // Merge departments + sections into a single DeptOption[] for the dropdown
    ...
    // Wire Requery onClick + live deptOptions into the filter config
