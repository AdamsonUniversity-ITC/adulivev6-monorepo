...
type LoaderPayload = { school_years?: string[]; units?: LoaderUnit[] };
type Preview = {
  report: {
...
function PrintPreview({ preview, onClose }: { preview: Preview; onClose: () => void }) {
  ...
  return <div className="adjustment-report-preview fixed inset-0 z-[100] overflow-auto bg-slate-600/80 p-3 sm:p-6" role="dialog" aria-modal="true" aria-label="Adjustments per department print preview">
