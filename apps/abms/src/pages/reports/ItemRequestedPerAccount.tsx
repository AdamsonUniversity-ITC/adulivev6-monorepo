...
function PrintPreview({ preview, onClose }: { preview: Preview; onClose: () => void }) {
  ...
  return <div className="requested-report-preview fixed inset-0 z-[100] overflow-auto bg-slate-600/80 p-3 sm:p-6" role="dialog" aria-modal="true" aria-label="Item requested per account print preview">
    ...
    <article className="requested-report mx-auto min-h-[700px] max-w-[1200px] bg-white p-7 text-black shadow-2xl sm:p-10">
