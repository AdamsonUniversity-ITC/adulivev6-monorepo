...
type LoaderPayload = RequisitionDateDefaultsPayload & { school_years?: string[]; main_accounts?: MainAccount[]; units?: Unit[]; unit_scope_restricted?: boolean };
