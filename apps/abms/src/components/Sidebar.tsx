...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Budget Settings', href: '/admin/budget-settings', permissions: ['admin-access', 'controller-access'] },
      { label: 'Budget Status', href: '/admin/budget-status', permissions: ['no-access'] },
      { label: 'Budget Review', href: '/admin/budget-review', permissions: ['admin-access', 'controller-access'] },
      { label: 'Budget Transfer Account', href: '/admin/budget-transfer-account', permissions: ['admin-access', 'controller-access'] },
      { label: 'Budget Adjustment Entry', href: '/admin/budget-adjustment-entry', permissions: ['admin-access', 'controller-access'] },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Budget Request Entry', href: '/transactions/budget-request-entry', permissions: ['allow-budget-request-entry', 'admin-access', 'budget-access'] },
  ...
  },
  {
    ...
    label: 'Reports',
    children: [
      { label: 'Budget Performance Per Department', href: '/reports/budget-performance-department', permissions: ['admin-access', 'budget-access', 'controller-access', 'allow-budget-request-entry', 'allow-budget-proposal-entry'] },
      ...
      { label: 'Item Requested Per Account', href: '/reports/item-requested-per-account', permissions: ['admin-access', 'budget-access', 'controller-access', 'allow-budget-request-entry', 'allow-budget-proposal-entry'] },
